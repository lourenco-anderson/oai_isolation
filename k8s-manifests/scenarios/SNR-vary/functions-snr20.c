...
static int size_tb = 96264; /* bits */
static int segments = 12;    /* LDPC segments (1 to 8) */
static int lift_size = 352; /* Lifting size */
static int coded_tb_size = 123552; 
static int g_modulation_order = 6; /* 2=QPSK,4=16QAM,6=64QAM,8=256QAM */
static int coded_symbols = 20592;
static int n_layers = 3;
static int n_tx = 8;
static int n_rx = 4;
static int n_taps = 11;
static int snr_db_input = 20;
